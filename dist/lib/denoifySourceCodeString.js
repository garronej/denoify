...
function commonJsImportStringToDenoImportStringFactory(params) {
    ...
    function commonJsImportStringToDenoImportString(params) {
        return __awaiter(this, void 0, void 0, function () {
            var fileDirPath, importStr, out_1, _a, nodeModuleName, rest, resolveResult, url, tsconfigOutDir, denoDistPath, out, is404;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (rest.length === 0) {
                            return [2 /*return*/, urlJoin(url, "mod.ts")];
                        }
                        out = urlJoin(url, path.join(denoDistPath, path.relative(tsconfigOutDir, path.join.apply(path, rest)) //  tools/typeSafety
