...
import { consumeExecutableReplacerFactory } from "../src/lib/replacer";
...
describe("replacer for changing import/export statement from node-compatible to deno-compatible import", () => {
    ...
    describe("change the import specifier", () => {
        it("should change the import of graphql", async () => {
            expect(
        ...
        it("should change the import of rxjs", async () => {
            expect(
                await consumeExecutableReplacer({
        ...
        it("should change the imoprt of rxjs/operators", async () => {
            expect(
                await consumeExecutableReplacer({
    ...
    describe("change the namespace and/or default import", () => {
        it("should change the import for operators", async () => {
        ...
        it("shoule the import for web socket", () => {
        ...
        it("should change the import of ipaddr", async () => {
            expect(
                await consumeExecutableReplacer({
        ...
        it("should change the import of fast-xml-parser", async () => {
            expect(
                await consumeExecutableReplacer({
        ...
        it("should change the import of React", () => {
        ...
        it("should change the import of react dom", () => {
        ...
        it("should change the import of react dom server", () => {
