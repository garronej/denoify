...
type ResolveNodeModuleToDenoModule = ReturnType<ReturnType<typeof resolveNodeModuleToDenoModuleFactory>["resolveNodeModuleToDenoModule"]>;
...
const testResolveNodeModuleToDenoModule = () =>
...
export default testResolveNodeModuleToDenoModule;
