...
**NEW IN v0.7**  
- Support for workspaces where `node_modules` are located in a parent directory. Example yarn workspaces. [See issue](https://github.com/garronej/denoify/issues/23)
