...
const listThirdPartyDenoModulesByPage = addCache_1.addCache(async (params) => {
    ...
    "filePathForPersistanceAcrossRun": path.join(getProjectRoot_1.getProjectRoot(), "res", "cache", "listThirdPartyDenoModulesByPage.json")
});
...
exports.getThirdPartyDenoModuleInfos = addCache_1.addCache(async (params) => {
    ...
    "filePathForPersistanceAcrossRun": path.join(getProjectRoot_1.getProjectRoot(), "res", "cache", "getThirdPartyDenoModuleInfos.json")
});
