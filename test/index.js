...
var Deferred_1 = require("evt/dist/tools/Deferred");
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _loop_1, _a, _b, name, e_1_1;
    var e_1, _c;
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                child_process.fork(__filename, undefined, { "env": { "FORK": path.join(__dirname, name) } })
                                    ...
                                    .once("exit", function (code) { return dExitCode.resolve(code); });
