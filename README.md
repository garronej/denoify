...
> 🗣️ If your project has **no dependencies** and **is not using any Node builtins** (fs, https, process ect...), you can do without Denoify by using TypeScript compiler option `moduleResolution: bundler`.  
